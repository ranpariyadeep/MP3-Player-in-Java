...
public class PlayListTest {
    ...
    // Whether arguments of setCurrent() are to be checked for validity is not
    // specified.
    ...
    public void testLoopAudioFiles() {
        ...
        try {
            files = Arrays.asList(new TaggedFile("audiofiles/Rock 812.mp3"),
        ...
        for (int i = 0; i < 5 * files.size(); i++) {
            ...
            assertEquals("currentAudioFile() yields wrong AudioFile", files.get(i % files.size()).toString(),
                    cur.toString());
            pl.nextSong();
        }
    }
    ...
    public void testSingleFileLoop() {
        ...
        for (int i = 0; i < 5; i++) {
            AudioFile cur = pl.currentAudioFile();
            assertEquals("currentAudioFile() yields wrong AudioFile", file.toString(), cur.toString());
            pl.nextSong();
        }
    }
    ...
    public void testCallingNextSongFirst() {
        ...
        pl.nextSong();
        AudioFile cur = pl.currentAudioFile();
        assertEquals("currentAudioFile() yields wrong AudioFile", files.get(1).toString(), cur.toString());
    }
    ...
    public void testSaveAndLoadM3U() {
        ...
        assertEquals("Load PlayList from M3U file yields wrong result",
                "[Eisbach - Rock 812 - The Sea, the Sky - 05:31, " + "wellenmeister - tranquility - 02:21, "
    ...
    public void testLenientLoadM3U() {
        ...
        assertEquals("PlayList generates entries for non-existent AudioFiles", 0, pl.size());
        // Cleanup
        m3u.delete();
    }
    ...
    public void testLenientLoadM3UHarder() {
        ...
        pl = new PlayList(m3uName);
        assertEquals("Load PlayList from M3U file yields wrong result",
                "[Eisbach - Rock 812 - The Sea, the Sky - 05:31]", pl.toString());
    ...
    /**
     * Here we check sorting according to album criteria. Note that sorting of
     * strings with compareTo() depends on the lexicographic order of letters in the
     * ASCII code. Therefore, "TANOM..." < "kein.wav..."
     */
    @Test
    public void testSortByAlbum() {
        ...
        assertEquals("Sorting according to criterion album is not correct",
                "[wellenmeister - tranquility - 02:21, " + "kein.wav.sondern - 00:00, "
    ...
    /**
     * Here we check sorting according to author criteria. Note that sorting of
     * strings with compareTo() depends on the lexicographic order of letters in the
     * ASCII code. Therefore, "TANOM..." < "kein.wav..."
     */
    @Test
    public void testSortByAuthor() {
        ...
        assertEquals("Sorting according to criterion author is not correct",
                "[kein.wav.sondern - 00:00, " + "Eisbach - Rock 812 - The Sea, the Sky - 05:31, "
                        + "Wellenmeister - TANOM Part I: Awakening - TheAbsoluteNecessityOfMeaning - 05:55, "
    ...
    /**
     * Here we check sorting according to title criteria. Note that sorting of
     * strings with compareTo() depends on the lexicographic order of letters in the
     * ASCII code. Therefore, "TANOM..." < "kein.wav..."
     */
    @Test
    public void testSortByTitle() {
        ...
        assertEquals("Sorting according to criterion title is not correct",
                "[Eisbach - Rock 812 - The Sea, the Sky - 05:31, "
                        + "Wellenmeister - TANOM Part I: Awakening - TheAbsoluteNecessityOfMeaning - 05:55, "
                        + "kein.wav.sondern - 00:00, " + "wellenmeister - tranquility - 02:21]",
                loop(pl1).toString());
    }

    /**
     * Here we check sorting according to duration criteria. Note that sorting of
     * strings with compareTo() depends on the lexicographic order of letters in the
     * ASCII code. Therefore, "TANOM..." < "kein.wav..."
     */
    @Test
    public void testSortByDuration() {
        ...
        assertEquals("Sorting according to criterion duration is not correct",
                "[kein.wav.sondern - 00:00, " + "wellenmeister - tranquility - 02:21, "
                        + "Eisbach - Rock 812 - The Sea, the Sky - 05:31, "
                        + "Wellenmeister - TANOM Part I: Awakening - TheAbsoluteNecessityOfMeaning - 05:55]",
                loop(pl1).toString());
    ...
    /**
     * Here we set search and sort, iterate and unset these again to check if
    ...
    public void testSearchAndSortDoesNotChangeOrder() {
        ...
        try {
            check = Arrays.asList(new TaggedFile("audiofiles/Rock 812.mp3"),
    ...
    /**
     * Test if jump to is working as expected. Jump to should change iteration and
     * return value of currentAudioFile.
     */
    @Test
