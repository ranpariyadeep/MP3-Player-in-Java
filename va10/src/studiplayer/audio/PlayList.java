...
public class PlayList implements Iterable<AudioFile> {
    ...
    public void loadFromM3U(String pathname) throws IOException {
        audioFiles.clear();
    ...
    public void jumpToAudioFile(AudioFile file2) {
        if (audioFiles.indexOf(file2) != -1) {
            iterator = audioFiles.listIterator(audioFiles.indexOf(file2));
            currentSong = iterator.next();
        } else {
            resetIterator();
        }
